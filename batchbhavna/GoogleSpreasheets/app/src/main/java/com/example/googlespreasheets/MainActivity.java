package com.example.googlespreasheets;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void insertdata(String name_text, String numbet_text) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbxBaUqdJLqps__1wUaS68RPZhdyde9VKl-FjMkaY9-YwjSd5nPbjq-2-fWjzj7lGvS8/exec",
