...
public class StudentDetails extends AppCompatActivity {
    ...
    private void deleteitem() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://script.google.com/macros/s/AKfycbyQMQgSb6mo_0OQ8a2EO0Y-Ogn_K67k2GP8UvgrAJjtVGrlwWURLagU/exec?action=delete&id="+id_text, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                detailProgressBar.setVisibility(View.GONE);
                Toast.makeText(StudentDetails.this, response, Toast.LENGTH_SHORT).show();
            }
    ...
    private void updatedata() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbzJ4tQx9urvqCzbH2aUBCbjag04ly3sphyRSMBiMBHYpXFDWGyN6SXZ/exec", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                detailProgressBar.setVisibility(View.GONE);
                Toast.makeText(StudentDetails.this, response, Toast.LENGTH_SHORT).show();
    ...
    private void bindviews() {
        editname = findViewById(R.id.update_user_name);
