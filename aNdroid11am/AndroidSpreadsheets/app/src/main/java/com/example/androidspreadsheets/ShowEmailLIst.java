...
public class ShowEmailLIst extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_email_l_ist);
        bindviews();
        getdata();
        updatviews();
    ...
    private void deleteitem() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,
                ...
                "https://script.google.com/macros/s/AKfycbzJ4tQx9urvqCzbH2aUBCbjag04ly3sphyRSMBiMBHYpXFDWGyN6SXZ/exec?action=delete&id="+id_text,
                new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                detailProgressBar.setVisibility(View.GONE);
                Toast.makeText(ShowEmailLIst.this, response, Toast.LENGTH_SHORT).show();
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ShowEmailLIst.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ShowEmailLIst.this);
    ...
    private void updatedata() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                "https://script.google.com/macros/s/AKfycbzJ4tQx9urvqCzbH2aUBCbjag04ly3sphyRSMBiMBHYpXFDWGyN6SXZ/exec",
                new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                detailProgressBar.setVisibility(View.GONE);
